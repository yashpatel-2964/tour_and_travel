...
<section class="form">
	...
	<form method="post" action="procces_package.php">
          <input type="package_name" name="package_name" value="package_name" >
          <input type="day_night" name="day_night" value="day_night">
  ...
  <button type="submit" name="add" class="btn">Add package</button>
</form>
