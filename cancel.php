...
<!-- header section ends -->
<?php
// assume we have variables $isCancelled, $reason, $cancellationFee
...
if (isset($_POST['delete'])) {
  ...
  $stmt = "DELETE FROM booking_table WHERE book_id = '$book_id'";
  mysqli_query($conn, $stmt);
  echo "your trip successfully cancel";
  ...
  switch ($_POST['delete']) {
    case 'bad weather':
      $cancellationFee = 0; // no fee for bad weather
      break;
    case 'illness':
      $cancellationFee = 10; // $10 fee for illness
      break;
    case 'change of plans':
      $cancellationFee = 5; // $5 fee for change of plans
      break;
    default:
      $cancellationFee = 20; // $20 fee for other reasons
      break;
      
  }
} else {
  $cancellationFee = 0; // no cancellation fee if not cancelled
  
  
}

// output cancellation fee
