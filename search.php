...
<section class="header">
  ...
  <a href="#" class="logo"><img src="web/.png" alt=""></a>
   ...
   <nav class="navbar">
         <a href="<?php echo "user_php.php?r_id=".$r_id.""?>">Home</a>
...
$r_id = $_REQUEST['r_id'];
   ...
   $query = "select s.state_id,s.state_name, p.package_name, p.price, p.day_night,p.image from state_table s,packa_table p  where  s.state_id=p.package_id and package_name like '%$search%'";
...
<div class=\"box-container\">
    ...
    <div class=\"box\">
      ...
      <div class=\"content\">
         <h3><i class=\"fas fa-map-marker-alt\"></i> "  . $row['package_name'] . " </h3>
          <h4>"  . $row['day_night'] . " </h4>
           <h4>"  . $row['price'] . " </h4>
