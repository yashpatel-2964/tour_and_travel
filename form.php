...
$qry = "Select * from packa_table where package_id=".$package_id;
$result = mysqli_query($conn,$qry);

while($row = mysqli_fetch_array($result)){
	?>

	<form method="post" action="procces_package.php">
          <input type="package_name" name="package_name" value="<?php echo $row['package_name'] ?>" >
          <input type="day_night" name="day_night" value="<?php echo $row['day_night'] ?>">
          <input type="price" name="price" value="<?php echo $row['price'] ?>">
  ...
  <button type="submit" name="update" class="btn">Update package</button>
</form>
<?php
}
