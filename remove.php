...
?>
 ...
 <form action="cancel.php" method="post">
      <label>
        <input type="checkbox" name="reasons[]" value="bad weather">
        Bad Weather
      </label>
      <label>
        <input type="checkbox" name="reasons[]" value="illness">
        Illness
      </label>
      <label>
        <input type="checkbox" name="reasons[]" value="change of plans">
        Change of Plans
      </label>
      <input type="submit" value="remove" class="btn" name="delete">
