...
$total_person=$_GET['total_person'];
$total_amount = $price * $total_person;
?>
...
<tr>
  ...
  <td><input type="" value="<?php echo $price;?>"  name="price"></td>
  <td><input type="" value="<?php echo $package_name;?>"  name="package_name"></td>
  <td><input type="" value="<?php echo $book_date;?>" name="book_date"></td>
  <td><input type="" value="<?php echo $journey_date;?>"  name="journey_date"></td>
  <td><input type="" value="<?php echo $total_person;?>"  name="total_person"></td>
  <td><input type="" value="<?php echo $total_amount;?>" name="total_amount"></td>
