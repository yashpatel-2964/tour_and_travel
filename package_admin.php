                ...
                <div class="records table-responsive">
                    ...
                    <div class="record-header">
                        <div class="add">
                            ...
                            <button><a href="package_form.php"> Add record</button></a>
                        </div>
...
echo"
    <tr>
        ...
        <td><a href='delete.php?package_id=" . $row['package_id'] . "' class=\"btn\"><i class=\"fa fa-trash\" aria-hidden=\"true\"></i></a></td>
        <td><a href='form.php?package_id=" . $row['package_id'] . "' class=\"btn\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i></a></td>
    </tr>
    "
?>
</table>
